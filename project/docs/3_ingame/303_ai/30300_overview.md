...
2. ⏳ 詳細仕様の策定
   - 30301_movement_spec.md: ボール追跡の詳細（MVP v0.1）
   - 30302_shot_spec.md: 返球判断の詳細（MVP v0.1）
   - 30303_prediction_spec.md: 軌道予測の詳細（v0.2以降）
   - 30304_difficulty_spec.md: 難易度調整の詳細（v0.2以降）
