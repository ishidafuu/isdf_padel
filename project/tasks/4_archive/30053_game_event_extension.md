...
blocks:
  ...
  - "30055"
  - "30056"
branch_name: "task/30053-game-event-extension"
worktree_path: "/Users/ishidafuu/Documents/repository/isdf_padel_30053"
...
- [x] GameEvent enumに3つの新イベント追加（ShotAttributesCalculated, AiMovementDecision, PhysicsAnomaly）
- [x] type_name() メソッド拡張
- [x] to_csv_detail() メソッド拡張
- [x] to_json() メソッド拡張
- [x] ビルド成功
