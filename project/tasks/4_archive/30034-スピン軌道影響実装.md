...
blocked_by: []
blocks: []
branch_name: "auto-30034-spin-trajectory"
worktree_path: "../isdf_padel-30034"
plan_file: null
tags: ["v0.3", "spin", "trajectory"]
parent_task_id: null
created_at: "2026-01-08T13:28:00"
updated_at: "2026-01-08T16:00:00"
completed_at: "2026-01-08T16:00:00"
---
...
- [x] `config.rs`: SpinPhysicsConfig構造体追加
- [x] `game_config.ron`: spin_physicsセクション追加
- [x] `GameConfig`: spin_physicsフィールド追加

### Step 2: システム修正

- [x] `ball_gravity_system`: BallSpin参照追加、重力変動計算
- [x] `ball_ground_bounce_system`: スピン考慮のバウンド計算

### Step 3: システム追加

- [x] `ball_air_drag_system`: 空気抵抗（新規）
- [x] `ball_spin_decay_system`: スピン減衰（新規）

### Step 4: システム登録

- [x] BallTrajectoryPlugin のシステム登録順序更新

### Step 5: テスト

- [x] ビルド・テスト通過確認（全135テスト通過）
...
- [x] SpinPhysicsConfigが実装され、RONで設定可能
- [x] トップスピンでボールが早く落ちる
- [x] スライスでボールが浮く
- [x] バウンド時にスピンに応じた挙動変化がある
- [x] スピン効果が時間経過で減衰する
- [x] 空気抵抗がスピンに応じて適用される
- [x] 全テストが通過する
