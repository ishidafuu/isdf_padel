...
- 🎮 game-reference-agent.md - 参照ゲームの仕様抽出
- 🔬 legacy-analyzer-agent.md - レガシーコード解析時の仕様抽出
...
- `agents/game-reference-agent.md` - 参照ゲーム仕様記録エージェント
- `agents/legacy-analyzer-agent.md` - レガシーコード解析エージェント
