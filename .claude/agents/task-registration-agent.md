...
プランファイルからタスクファイルへの変換手順を定義します。

**処理内容:**
- プランファイルの自動検出（最新のファイルを選択）
- タスクタイプの判定（framework/game-dev/project-wide）
- ID採番とタスクファイル生成
- プラン内容の構造化とタスクフォーマットへの変換
