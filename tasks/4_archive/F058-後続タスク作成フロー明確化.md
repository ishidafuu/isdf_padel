...
completed_at: "2026-01-09T17:00:00+09:00"
---
...
- [x] 「2.1. 後続タスクの作成（CRITICAL）」セクションを追加
- [x] 必須フロー（プランモード → task-registration-agent）を記載
- [x] 禁止事項（手動作成、frontmatter なし）を明記

### 2. task-lifecycle.md への追加

- [x] 「後続タスク作成ガイドライン（CRITICAL）」セクションを追加
- [x] 発生シナリオ（リファクタ完了時、バグ修正完了時、機能実装中）を記載
- [x] 禁止事項と理由を表形式で明記

## 完了チェックリスト

- [x] 変更内容の検証完了
- [x] ドキュメント整合性確認（task-manager-agent.md と task-lifecycle.md の記述が矛盾しないこと）
